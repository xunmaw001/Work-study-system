...
public class XinzifafangView extends XinzifafangEntity implements Serializable {
	...
	public XinzifafangView() {

	}

	public XinzifafangView(XinzifafangEntity xinzifafangEntity) {
		try {
			BeanUtils.copyProperties(this, xinzifafangEntity);
