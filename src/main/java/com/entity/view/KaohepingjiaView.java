...
public class KaohepingjiaView extends KaohepingjiaEntity implements Serializable {
	...
	public KaohepingjiaView() {

	}

	public KaohepingjiaView(KaohepingjiaEntity kaohepingjiaEntity) {
		try {
			BeanUtils.copyProperties(this, kaohepingjiaEntity);
